...
class _ProfileState extends State<Profile> {
  ...
  buildProfileButton(){
     //viewing own profile ? - Show wedit profile;
  ...
  handleFollowUser(){
    ...
    .document(currentUserId)
    .setData({});
    // put that user on your following collection(update current user's following collection)
    followingRef
    .document(currentUserId)
    .collection("userFollowing")
    .document(widget.profileId)
    ...
    //add activity feed item to that user to notify them about follower
    activityFeedRef
    .document(widget.profileId)
    .collection("feedItems")
    .document(currentUserId)
